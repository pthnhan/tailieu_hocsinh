...
\setcounter{ex}{0}
	\input DS/10D1-TL-1
	\include{DS/10D1-TL-2}
	\include{DS/10D1-TL-3}
	\include{DS/10D1-TL-4}
	\include{DS/10D1-TL-KT}


\chapter{HÀM SỐ BẬC NHẤT VÀ BẬC HAI}
\setcounter{ex}{0}
	\input DS/10D2-TL-1
	\include{DS/10D2-TL-2}
	\include{DS/10D2-TL-3}
	\include{DS/10D2-TL-KT}


\chapter{PHƯƠNG TRÌNH VÀ HỆ PHƯƠNG TRÌNH}
\setcounter{ex}{0}
	\input DS/10D3-TL-1
	\include{DS/10D3-TL-2}
	\include{DS/10D3-TL-3}
	\include{DS/10D3-TL-4}
	\include{DS/10D3-TL-KT}


\chapter{BẤT ĐẲNG THỨC VÀ BẤT PHƯƠNG TRÌNH}
\setcounter{ex}{0}
	\input DS/10D4-TL-1
	\include{DS/10D4-TL-2}
	\include{DS/10D4-TL-3}
	\include{DS/10D4-TL-4}
	\include{DS/10D4-TL-5}
	\include{DS/10D4-TL-KT}


\chapter{THỐNG KÊ}
\setcounter{ex}{0}
	\input DS/10D5-TL-1
	\include{DS/10D5-TL-2}
	\include{DS/10D5-TL-3}
	\include{DS/10D5-TL-4}
	\include{DS/10D5-TL-KT}


\chapter{CUNG VÀ GÓC LƯỢNG GIÁC. CÔNG THỨC LƯỢNG GIÁC}
\setcounter{ex}{0}
	\input DS/10D6-TL-1
	\include{DS/10D6-TL-2}
	\include{DS/10D6-TL-3}
	\include{DS/10D6-TL-KT}
\end{document}
