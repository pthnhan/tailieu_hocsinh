...
\chapter{ỨNG DỤNG ĐẠO HÀM}
	...
	\input{DS/12D1-TL-1}
	\newpage\input{DS/12D1-TL-2}
	\newpage\input{DS/12D1-TL-3}
	\newpage\input{DS/12D1-TL-4}
	\newpage\input{DS/12D1-TL-5}
	\newpage\input{DS/12D1-TL-KT}

\chapter{LŨY THỪA, MŨ, LÔ-GA-RIT}
	\setcounter{section}{0}
	\input{DS/12D2-TL-1}
	\newpage\input{DS/12D2-TL-2}
	\newpage\input{DS/12D2-TL-3}
	\newpage\input{DS/12D2-TL-4}
	\newpage\input{DS/12D2-TL-5}
	\newpage\input{DS/12D2-TL-6}
	\newpage\input{DS/12D2-TL-KT}

\chapter{NGUYÊN HÀM, TÍCH PHÂN}
	\setcounter{section}{0}
	\input{DS/12D3-TL-1}
	\newpage\input{DS/12D3-TL-2}
	\newpage\input{DS/12D3-TL-3}
	\newpage\input{DS/12D3-TL-KT}

\chapter{SỐ PHỨC}
	\setcounter{section}{0}
	\input{DS/12D4-TL-1}
	\newpage\input{DS/12D4-TL-2}
	\newpage\input{DS/12D4-TL-3}
	\newpage\input{DS/12D4-TL-4}
	\newpage\input{DS/12D4-TL-KT}
\end{document}
